...
To test the model with your own image, import the image into the ```test_images``` folder and run ```python3 predict_image.py``` to generate a corresponding caption
